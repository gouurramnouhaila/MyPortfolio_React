...
function Tooltip(props) {
  var allowedAutoPlacements = props.allowedAutoPlacements,
      ...
      tone = props.tone,
      restProps = _objectWithoutProperties(props, ["allowedAutoPlacements", "children", "className", "content", "disabled", "fallbackPlacements", "placement", "portal", "tone"]);
...
function TooltipPopper(props) {
  var arrowStyle = props.arrowStyle,
      ...
      style = props.style,
      tone = props.tone,
      restProps = _objectWithoutProperties(props, ["arrowStyle", "className", "content", "setArrowElement", "setPopperElement", "style", "tone"]);
