...
export default function SingleProject () {
    ...
    return (
        <main className="min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-red-100 rouded-lg">
                ...
                <div className="px-16 llg:px-48 py-20 prose lg:proce-xl max-w-full">
                    <BlockContent blocks={singlePost.body} projectId="ze0bjeck" dataset="production" />
                </div>
            </article>
        </main>
    )
