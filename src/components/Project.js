    ...
    return (
        <main className=" min-h-screen p-12" >
            <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justify-center mb-12 font-mono">Welcome to my projects page!</h2>
                <section className="grid grid-cols-2 gap-8">
                    ...
                    <article className="relative rounded-lg shadow-xl bg-white p-16">
                        ...
                        <div className="text-gray-500 text-xs space-x-4">
                            ...
                            <a href={project.link} rel="noopener noreferrer" target="_blank" className="text-red-300 font-bold hover:underline hover:text-red-2 00">
                                View The Project{" "}
