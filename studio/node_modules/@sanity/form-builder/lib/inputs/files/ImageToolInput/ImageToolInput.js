...
var ImageToolInput = /*#__PURE__*/(0, _react.forwardRef)(function ImageToolInput(props, ref) {
  ...
  var handleChangeEnd = (0, _react.useCallback)(() => {
    if (readOnly) {
      return;
    ...
    }, localValue.crop || _constants.DEFAULT_CROP) : localValue.crop;
    var hotspot = hotspotField ? _objectSpread({
      _type: hotspotField.type.name
    }, localValue.hotspot || _constants.DEFAULT_HOTSPOT) : localValue.hotspot;
